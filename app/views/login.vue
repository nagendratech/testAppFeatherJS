...
.login-form-container
	...
	.login-form-body
		.login-form(v-show="showing === 'login'")
			...
			.login-form-forgot-password(@click="emailform()", v-show="showing === 'login'") send Email?
		...
		.change-email-form(v-show="showing === 'changeEmail' && auth.currentUser")
			.login-form-group
				.login-form-email-icon.login-form-icon To
				
				input.login-form-email-input.login-form-input(type='email', placeholder='email' v-model="user.newEmail")
			.login-form-group
				.login-form-password-icon.login-form-icon Subject
					
				input.login-form-password-input.login-form-input(type='text', placeholder='subject' v-model="user.subject")
				.login-form-group
				.login-form-password-icon.login-form-icon body
					
				input.login-form-password-input.login-form-input(type='text', placeholder='body' v-model="user.body")
			.login-form-warning-text
			.login-form-change-email-btn(@click="auth.sendResetPassword(user)") Send
</template>
